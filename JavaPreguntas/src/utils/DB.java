...
public class DB {
    ...
    private String url = "jdbc:mysql://localhost:3306/app_preguntas";
    private String driver = "com.mysql.cj.jdbc.Driver";
    
    private String userTest = "root";
    private String passwordTest = "";
    private String urlTestInit = "jdbc:h2:mem:test;MODE=MYSQL;INIT=RUNSCRIPT FROM 'C:/Users/anam1/OneDrive/Desktop/mision tic/programacion/modulo 2/model_parking.sql';DB_CLOSE_DELAY=-1";
